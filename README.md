# Generate an API key with given link below https://openweathermap.org/guide and https://restcountries.eu/rest/v2/all Print the current weather data in console- By lat lang along with country name
